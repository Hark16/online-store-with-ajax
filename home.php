...
$sql1 = "SELECT * FROM $wln1 WHERE live='live'";
...
<button onclick='fun3("<?php echo$row1['id']; ?>");'>
...
window.location.assign("store.php?c="+cat);
}


function fun3(idnum){

window.location.assign("product_1.php?idnum="+idnum);
